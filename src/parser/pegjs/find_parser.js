...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$startRuleFunctions = { op3: peg$parseop3 },
        peg$startRuleFunction  = peg$parseop3,

        peg$c0 = function(left, type, right) { return {type,left,right}},
        peg$c1 = function(op) { return op },
        peg$c2 = ".",
        ...
        peg$c32 = "in",
        peg$c33 = peg$literalExpectation("in", false),
        peg$c34 = function() { return "in" },
        peg$c35 = "[",
        ...
        peg$c63 = function(head, m) { return m; },
        ...
        peg$c109 = /^[^\0-\x1F"\\]/,
        peg$c110 = peg$classExpectation([["\0", "\x1F"], "\"", "\\"], true, false),
        peg$c111 = /^[0-9]/,
    ...
    function peg$parseop2() {
      ...
      s0 = peg$currPos;
      s1 = peg$parsebegin_round();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseop3();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseend_round();
          if (s3 !== peg$FAILED) {
            peg$savedPos = s0;
            s1 = peg$c1(s2);
            s0 = s1;
